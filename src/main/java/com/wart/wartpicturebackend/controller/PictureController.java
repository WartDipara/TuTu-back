...
//  @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
  ...
  public BaseResponse<PictureTagCategory> listPictureTagCategory() {
    ...
    List<String> tagList = Arrays.asList("Hots", "Funny", "Life", "HQ", "Art", "School", "Background", "Resume", "Creative");
    List<String> categoryList = Arrays.asList("Template", "E-Commerce", "Meme", "Material", "Poster");
